...
#         self.enc1 = nn.Conv2d(3, 64, 3, 1, 1)
        ...
        self.enc4 = nn.Conv2d(16, 16, 3, 1, 1)
        #self.enc4_bn = nn.BatchNorm2d(16)
        self.enc5 = nn.Conv2d(16, 8, 3, 1, 1)
        #self.enc5_bn = nn.BatchNorm2d(8)
        self.enc6 = nn.Conv2d(8, 4, 3, 1, 1)
        #self.enc6_bn = nn.BatchNorm2d(4)
        # decoder 
        self.dec6 = nn.ConvTranspose2d(4, 8, 3, 1, 1)
        #self.dec6_bn = nn.BatchNorm2d(8)
        self.dec5 = nn.ConvTranspose2d(8, 16, 3, 1, 1)
       # self.dec5_bn = nn.BatchNorm2d(16)
        self.dec4 = nn.ConvTranspose2d(16, 16, 3, 1, 1)
